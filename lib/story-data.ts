...
export const STORY_INTRO = {
    kicker: 'Our Journey',
    title: 'A Dream, Rooted in Country',
    lead:
        'How a lifetime of lessons, carried across the world, became a home where every child belongs.',
};

export const STORY_CHAPTERS = [
    {
        n: 'Chapter One',
        title: 'The country that held us',
        paras: [
    ...
    },
    {
        ...
        paras: [
            'We did not arrive at early childhood in a straight line. Our journey wound through many different industries and sectors over many years — work that taught us patience and discipline, how to build something carefully, and how to look after the people inside it.',
            'We learned what it means to be trusted, and how easily trust can be broken. We learned that shortcuts rarely last, and that the things worth keeping are built slowly, with heart. We met people from every walk of life, and in all of them we saw the same truth: that who we become is shaped, more than anything, by how we were cared for at the very beginning.',
            'And through all of it — every role, every long day, every fresh start — the same question kept returning to us, first as a whisper and then as something we could no longer ignore: what are we really here to give back?',
        ],
        quote:
            'Every child is a seed of boundless potential. Our only task is to provide the right soil.',
    },
    {
        n: 'Chapter Three',
    ...
    },
    {
        ...
        pillars: [
            ...
            {
                stat: '5',
                title: 'A curriculum shaped like the landscape',
                text:
                    "Five series we call Seeds, Country, River, Seasons and High Country — learning that wasn't borrowed from somewhere far away, but grown here, in this soil, under this sky.",
            },
            {
                stat: '∞',
                title: 'Play as the truest way to learn',
                text:
                    'Because we know that wonder, curiosity and friendship are not a break from learning — they are the most powerful learning there is.',
            },
        ],
    },
    {
        ...
        paras: [
            'There is a quieter part of love — the part no one applauds — and it is this: the careful, unglamorous, never-ending work of keeping children safe. We chose to take it as seriously as anything we have ever done.',
            "We hold ourselves to Australia's National Quality Framework, to ACECQA and the VEYLDF, and to every one of the Victorian Child Safe Standards — not as boxes to be ticked, but as promises we make to every family who trusts us. When you place your child in our care, you hand us the most precious thing you have. We will never, ever treat that lightly. Every policy, every check, every quiet routine of supervision is simply love, written down where it can be kept.",
        ],
    },
    {
        n: 'Chapter Six',
...
export const STORY_CLOSING = {
    paras: [
        'That is the dream: to give back to the country that gave us everything — by giving everything to its youngest children.',
        'With all our heart, the Country Kids family.',
    ],
    sign: 'Seeds of learning · Roots of belonging',
};
